<template
  ><div>
    <div class="row mt-5">
      ...
      <div class="col-md-6">
        <h3 class="text-center">Avid Media: mac/os</h3>
      </div>
      <div class="col-md-3">
        <v-card-actions>
    ...
    <div class="row mt-0 mb-0">
      ...
      <div class="col-md-4 col-lg-4 col-sm-4">
        <p>
          <vue-flashcard
            ...
            back="Option + click Audio Track Monitor button"
            headerFront="Queston"
            footerFront=""
            footerBack=""
            colorFront="#424242"
      ...
      <div class="col-md-4 col-lg-4 col-sm-4">
        <p>
          <vue-flashcard
            front="What is the keystroke Moves selected audio keyframe horizontally in timeline?"
            back="Option + drag keyframe"
            headerFront="Queston"
            footerFront=""
            footerBack=""
            colorFront="#424242"
      ...
      <div class="col-md-4 col-lg-4 col-sm-4 mt-0 mb-0">
        <p>
          <vue-flashcard
            ...
            back="Cmd + drap clips between bins"
            headerFront="Question"
            footerFront=""
            footerBack=""
            colorFront="#424242"
      ...
      <div class="col-md-4 col-lg-4 col-sm-4">
        <p>
          <vue-flashcard
            ...
            back="Cmd + Select segment + delete key"
            headerFront="Question"
            footerFront=""
            footerBack=""
            colorFront="#424242"
